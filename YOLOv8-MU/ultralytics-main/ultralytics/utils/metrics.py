...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, MPIoU=False, eps=1e-7):
    """
    ...
    # IoU
    iou = inter / union
    if CIoU or DIoU or GIoU or MPIoU:
        cw = b1_x2.maximum(b2_x2) - b1_x1.minimum(b2_x1)  # convex (smallest enclosing box) width
        ch = b1_y2.maximum(b2_y2) - b1_y1.minimum(b2_y1)  # convex height
        if CIoU or DIoU or MPIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
